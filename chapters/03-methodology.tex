...
The corresponding \isi{confusion matrix} and statistics for Model~2 are given in \tabref{tab:model2-conf} and \tabref{tab:stats-model2}, respectively.
